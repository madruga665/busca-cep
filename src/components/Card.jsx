...
export default class Card extends Component {
    ...
    return (
      <>
        <div className="flex flex-col relative w-full">
          <div
            className="m-1 mb-3 text-gray-600 flex w-full 
          bg-yellow-100 border rounded p-1 border-white"
          >
  ...
  render() {
    ...
    return (
      <section className="bg-yellow-200 w-full sm:w-11/12 md:w-4/5 lg:w-2/5 xl:w-2/5 
      flex flex-col items-center py-6 px-3 my-4 shadow-xl border-t-8 border-yellow-400 rounded-lg">
